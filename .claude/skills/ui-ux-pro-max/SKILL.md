...
- **Stack**: Next.js 14+ (App Router, TypeScript) + Tailwind CSS + GSAP (ScrollTrigger, Flip, Observer) + Framer Motion + Lucide React (this project's tech stack)
...
| Stack | Focus |
|-------|-------|
| `nextjs` | Next.js 14+ App Router, TypeScript, Server/Client Components, next/image |
| `react` | React.js Web Components, SPA layouts, hooks |

**Next.js enterprise examples:**

```bash
python3 skills/ui-ux-pro-max/scripts/search.py "hero storytelling scrolltrigger bento grid" --stack nextjs
python3 skills/ui-ux-pro-max/scripts/search.py "glassmorphism neon glow card animation" --stack nextjs
```
...
- Stack: React.js (Web) + Styled-Components
